...
*/
$('head').append('<link rel="stylesheet" href="http://resources.marketingwizards.pl/validation/1.1.1/css/default_validation_styles.css" type="text/css" />');
$.getScript( "http://resources.marketingwizards.pl/validation/1.1.1/functions/functions.js" );
...
$(document).ready(function(){
	...
	/*
	* sStałe wartośći dla kodów konwersji
	*/
...
function send_form(step_effect1, step_effect2, step_effect_duration, data_form){
	...
	*/
	...
	if(table != 'external'){
		...
		*/
		...
		$.post(
			'http://resources.marketingwizards.pl/validation/1.1.1/FormToDatabase.php',{ 
			 fields: id_array, 
			 values: value_array,
			 table: table,
			 },
		...
		if(confirmation_emails != ''){
			$.post(
				 'http://resources.marketingwizards.pl/validation/1.1.1/SendConfimation.php',{ 
				 fields: id_array, 
				 values: value_array,
	...
	*/
	if(table == 'as_groupon'){
		...
		$.ajax({
			 url: 'http://resources.marketingwizards.pl/validation/1.1.1/functions/expire_groupon_kod_as.php',
			 type: "POST",
			 async: false,
			 data: {value: val}, 
	...
	if(table == 'service_panel'){
		...
		$.getScript( "http://resources.marketingwizards.pl/validation/1.1.1/functions/service_panel.js" )
