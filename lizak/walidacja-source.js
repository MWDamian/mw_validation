...
*/
$('head').append('<link rel="stylesheet" href="http://resources.marketingwizards.pl/validation/lizak/css/default_validation_styles.css" type="text/css" />');
$.getScript( "http://resources.marketingwizards.pl/validation/lizak/functions/functions.js" );
	...
	$(".validate").each(function(index, element) {
        ...
        if($(this).data('mask')){
			if(script_loaded == false){
				$.ajax({
					type: "GET", 
					url:'http://resources.marketingwizards.pl/validation/lizak/js/jquery.maskedinput.min.js',
					data :'',
					async:false,
					dataType:"script",
	...
	*/
	...
	if(table != 'external'){
		...
		*/
		...
		$.post(
			'http://resources.marketingwizards.pl/validation/lizak/FormToDatabase.php',{ 
			 fields: id_array, 
			 values: value_array,
			 table: table,
			 },
		...
		if(confirmation_emails != ''){
			$.post(
				 'http://resources.marketingwizards.pl/validation/lizak/SendConfimation.php',{ 
				 fields: id_array, 
				 values: value_array,
